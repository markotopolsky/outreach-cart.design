...
|---|---|---|---|---|
| 1 | Tatramodel | ✅ 2026-07-20 | **2026-07-20, 14:20** (zistené v Gmaile 3.8.) | — (14 dní bez odpovede) |
| 2 | Vcelo | ✅ 2026-07-20 | **2026-07-21, 09:29** (zistené v Gmaile 3.8.) | — (13 dní bez odpovede) |
| 3 | Konvička | ✅ 2026-07-20 | **2026-07-21, 09:28** (zistené v Gmaile 3.8.) | — (13 dní bez odpovede) |
| 4 | Neoprot | ⏸️ pozdržané | — | — |

**⚠️ Korekcia (3.8.):** napriek výhrade nižšie boli všetky tri maily **odoslané presne v znení, ktoré
táto stránka označila za neodporúčané** — bez prepisu cez live prompt v2, variant B ako bol napísaný.
Vcelo a Konvička odišli 21.7., teda **v deň, kedy podľa [[dashboard|dashboardu]] začala pauza cold
outreachu** (dashboard eviduje explicitnú výnimku z pauzy len pre [[outreach-batch-12]]). Žiadna
odpoveď zatiaľ neprišla ani na jeden z troch mailov — pôvodná obava (akútnosť pain pointu 0, forma
variantu B) zatiaľ nevyvrátená ani potvrdená, vzorka je príliš malá.

Pôvodná výhrada (platí naďalej pre budúce použitie variantu B): všetky tri maily sú napísané
variantom B, ktorý v [[run-2026-07-21-zmrazene-spravy|run 2]] (21.7.) skončil **posledný vždy,
keď sa objavil**, u Marka aj u rubriky (4/12). Hooky samotné sú v poriadku, problém je forma:
dĺžka, fráza „Nebudem chodiť okolo horúcej kaše", dlhé pomlčky a ponuka hneď v prvej správe.

⚠️ Druhá, vážnejšia výhrada z run 2: Tatramodel aj Vcelo majú **akútnosť pain pointu 0** —
vieme o technickej chybe, ale nemáme dôkaz, že im dopyt prerastá cez kanál. Presne na tomto
zomrela darcekove_kytice (poznatok #1). Pred odoslaním doložiť dôkaz živého dopytu, inak
hrozí zopakovanie toho istého.
